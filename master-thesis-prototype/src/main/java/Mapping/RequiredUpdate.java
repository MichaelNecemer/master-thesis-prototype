...
public class RequiredUpdate {
	...
	public RequiredUpdate(BPMNTask lastWriter, BPMNDataObject dataO, BPMNBusinessRuleTask currentBrt, HashMap<BPMNBusinessRuleTask, LinkedList<BPMNParticipant>> alreadyChosenVoters, BPMNParticipant currentParticipant, LinkedList<String> spheresOfCurrPart, String update,double weightingOfLastWriterToWriteDataForBrt, double costForUpdate){
